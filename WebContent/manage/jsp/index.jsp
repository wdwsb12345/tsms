  ...
  <body>
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav">
                     <!--<li class="current">-->    
                   <li>             	
                        <a href="javascript:addTab('纳税人管理','listTaxPayer.jsp')">
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','searchTask.jsp')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','../../toAddTaskServlet.json')">调查任务录入</a></li>
	...
	$(".userInfo").click(function(){
			$("#topWindow").window({
				...
				width:800,
				height:300,
				content:"<iframe scrolling='no' width='100%' height='100%' src='../../UserInfoServlet.json?username=${username}'></iframe>"
			})
	})
	...
	$(".modify_pwd").click(function(){
		$("#topWindow").window({
				...
				width:400,
				height:300,
				content:"<iframe scrolling='no' width='100%' height='100%' src='modifypassword.jsp?username=${username}'></iframe>"
			})
	})
