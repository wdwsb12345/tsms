        ...
        <div title="纳税人信息" data-options="closable:false" class="basic-info">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content"><input type="text" readonly name="payerCode" value="${map.payerCode }"></td>
            ...
            <input type="hidden" name="payerId" value="${map.payerId }">
            <table class="kv-table">
                <tbody>
                <tr>
                    <td class="kv-label">任务名称</td>
                    <td class="kv-content"><input type="text" readonly name="taskName" value="${map.taskName }"></td>
                    ...
                    <td class="kv-content">
                     ...
                     <option value="${map.approverId }">${map.tr }</option>
                ...
                <tr>  
                  	...
                  	<td class="kv-content">    	
	                    ...
	                    <option value="${map.approverId }">${map.tf }</option>
                    ...
                    <td class="kv-content"><input type="text"  name="executeTime" value="${map.executeTime }"></td>
                    
                    <td class="kv-label">任务执行情况</td>
                    <td class="kv-content">
                        <textarea rows="3" name="taskState" style="width: 90%;">${map.taskState }</textarea>
                    </td>
