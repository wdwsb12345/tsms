			...
			<form id="addTask" method="post">
				<div title="纳税人信息" data-options="closable:false" class="basic-info">
					...
					<table class="kv-table" id="payerTable">
						<tbody>
							<tr><td><input type="hidden" name="id" id="id" value="${map.id }"></td></tr>
							<tr>
								<td class="kv-label">纳税人识别号</td>
								<td class="kv-content"><input type="text" name="payerCode" id="payerCode" value="${map.payerCode }"></td>
...
<script type="text/javascript">
	...
	$("#payerCode").blur(function(){
		...
		window.location.href = "AddTaskServlet.json?payerCode="+$("#payerCode").val();	
	})
