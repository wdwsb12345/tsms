					...
					<table class="kv-table" id="addPayer">
						<tbody>
							...
							<tr>
								...
								<td class="kv-content"><select name="taxOrganId" id="selectOrgan" >
								...
								<td class="kv-content"><select name="industryId" id="selectIndustry" >
							...
							<tr>
								...
								<td class="kv-content"><input type="text" name="bizScope"placeholder="生产经营范围"></td>
								<td class="kv-label">票种核定</td>
								<td class="kv-content"><select name="invoiceType">
							...
							<tr>
								...
								<td class="kv-content"><input type="text" name="legalPerson" placeholder="法人姓名"></td>
								<td class="kv-label">法人身份证号</td>
								<td class="kv-content"><input type="text" name="legalIdCard" placeholder="法人代表身份证号码"></td>
							</tr>
							<tr>
								<td class="kv-label">主管财务</td>
								<td class="kv-content"><input type="text" name="finaceName" placeholder="主管财务"></td>
								<td class="kv-label">财务身份证号</td>
								<td class="kv-content"><input type="text" name="finaceIdCard" placeholder="财务身份证号"></td>
							</tr>

							<tr>
								<td class="kv-label">法人身份证照片</td>
								<td class="kv-content"><img id="chooseLegalIdCardPreview" alt="" src="" />
									<div id="chooseLegalIdCard">选择文件</div> <input type="hidden" name="legalIdCardImageURL" id="legalIdCardUrl" /></td>
								<td class="kv-label">财务身份证照片</td>
								<td class="kv-content"><img id="chooseFinaceIdCardPreview" alt="" src="" />
									<div id="chooseFinaceIdCard">选择文件</div> <input type="hidden" name="finaceIdCardImageURL" id="finaceIdCardUrl" /></td>
							</tr>
							<tr>
								<td class="kv-label">录入人员</td>
								<td class="kv-content"><input type="text" name="userId"placeholder="录入人员"></td>
								<td class="kv-label">当前时间</td>
								<td class="kv-content"><input type="text" name="recordDate"placeholder="当前时间"></td>
							</tr>
						</tbody>
...
/* var chooseLegalIdCardUploader = WebUploader.create({
		    ...
		    // 文件接收服务端。
		    server: 'http://localhost:8080/tsms/uploadImg.do',		
		    // 选择文件的按钮。可选。
